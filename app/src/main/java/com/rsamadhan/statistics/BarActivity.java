package com.rsamadhan.statistics;
...
public class BarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Init third chart
        mUpdateThree = true;
        mChartThree = (BarChartView) findViewById(R.id.barchart3);
    ...
    public void produceOne(ChartView chart, Runnable action){
        ...
        Tooltip tooltip = new Tooltip(BarActivity.this, R.layout.barchart_one_tooltip);
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
    ...
    private void showTooltipOne(){
        ...
        for(int i = 0; i < areas.size(); i++) {
            for (int j = 0; j < areas.get(i).size(); j++) {
                ...
                Tooltip tooltip = new Tooltip(BarActivity.this, R.layout.barchart_one_tooltip, R.id.value);
    ...
    public void produceTwo(ChartView chart, Runnable action){
        ...
        Tooltip tip = new Tooltip(BarActivity.this, R.layout.barchart_two_tooltip);
